  ...
  if(ponentesInput) {
    ...
    function buscarPonentes(e) {
      ...
      if(busqueda.length >= 3) {
        // Busca los Ponentes sin importar si escribes en mayúsculas y/o minúsculas
        ...
        // Busca los Ponentes sin importar si escribes en mayúsculas, minúsculas y/o acentos
    ...
    function mostrarPonentes() {
      ...
      if(ponentesFiltrados.length > 0) {
        ponentesFiltrados.forEach(ponente => {
          ...
          ponenteHTML.onclick = seccionarPonente;
          // Añadir al DOM
