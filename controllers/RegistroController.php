...
class RegistroController {
  public static function crear(Router $router) {
    ...
    // Verificar si el usuario ya está registrado y/o eligió un plan
  ...
  public static function conferencias(Router $router) {
    ...
    // Validar que el usuario tengo un plan presencial
    $usuario_id = $_SESSION["id"];
    ...
    // Con ésta comprobación al finalizar la compra o registrar conferencias en el caso de ser presencial se redireccionará al boleto virtual
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST") {
      ...
      // Revisar que el ususario esté autenticado
      if(!is_auth()) {
        header("Location: /login");
        return;
      }
