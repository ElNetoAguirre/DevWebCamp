...
<div class="eventos-registro">
  <main class="eventos-registro__listado">
    <h3 <?php aos_animacion(); ?> class="eventos-registro__heading--conferencias">&lt;Conferencias/></h3>
    <p <?php aos_animacion(); ?> class="eventos-registro__fecha">Viernes 6 de Octubre</p>

    <div <?php aos_animacion(); ?> class="eventos-registro__grid">
      <?php foreach($eventos["conferencias_v"] as $evento) { ?>
        <?php include __DIR__ . "/evento.php"; ?>
      <?php } ?>
    </div>

    <p <?php aos_animacion(); ?> class="eventos-registro__fecha">Sábado 7 de Octubre</p>
    ...
    <h3 <?php aos_animacion(); ?> class="eventos-registro__heading--workshops">&lt;Workshops/></h3>
    <p <?php aos_animacion(); ?> class="eventos-registro__fecha">Viernes 6 de Octubre</p>

    <div <?php aos_animacion(); ?> class="eventos-registro__grid eventos--workshops">
